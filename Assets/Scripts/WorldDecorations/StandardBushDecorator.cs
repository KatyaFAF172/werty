...
public class StandardBushDecorator : IDecoration
{
    private readonly WorldData m_WorldData;

    public StandardBushDecorator(WorldData worldData)
    {
    ...
    private void CreateDecorationAt(int blockX, int blockY, int blockZ, Random random)
    {
        ...
        // Leaves
        CreateSphereAt(blockX, blockY, blockZ, random.RandomRange(1, 3));
    }
